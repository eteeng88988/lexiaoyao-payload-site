...
This project is deployed as `lexiaoyao-payload-site` on Cloudflare Workers:

- Worker URL: https://lexiaoyao-payload-site.amarilloanarchy243.workers.dev
- D1 database: `lexiaoyao-payload-site`
- R2 bucket: `lexiaoyao-payload-site`

For this Windows setup, deploy app updates with:
