/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: b51050e4bb1000583b8b0f5fbcde6c20)
// Runtime types generated with workerd@1.20260609.1 2026-06-13 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	R2: R2Bucket;
	D1: D1Database;
	ASSETS: Fetcher;
	NODE_ENV: "production";
	PAYLOAD_PUBLIC_SERVER_URL: "https://amatbuy.eu.org";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NODE_ENV" | "PAYLOAD_PUBLIC_SERVER_URL" | "PAYLOAD_SECRET">> {}
}
